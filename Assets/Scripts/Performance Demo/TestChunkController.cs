...
namespace ZeroByterGames.BlockBuilder.PerformanceDemo {
	public class TestChunkController : MonoBehaviour
	{
        ...
        private void Awake()
        {
            ...
            cubes[4, 1, 1] = new Cube();
            cubes[4, 1, 2] = new Cube();
            cubes[5, 1, 2] = new Cube();
            cubes[6, 1, 2] = new Cube();
